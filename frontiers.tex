...
who acquire neuroscientific knowledge on the job \bertrand{What Do You Mean ???} This paper aims to fill 
...
imply \bertrand{please be a bit more specific} and how to achieve the desired results. We discuss not only
...
transformation matrix (called affine) used to translate the voxel location
