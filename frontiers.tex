...
match these two events, we will sometimes have to shift our data. This can be
done by removing the two first scans of the data and the two last values of the
...
Classical preprocessing (detrend...) have been applied to the data.
