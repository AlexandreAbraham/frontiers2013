...
The masks derived from standard analysis in the original paper
\citep{haxby2001} are displayed blue and in green.}
\label{fig:haxby}
\end{figure}
...
form functional networks that are consistent with know task networks.
