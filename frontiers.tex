...
algorithms that iterates over the geometric structure of the data (see Searchlight
in \ref{searchlight}).
...
\cite{varoquaux2010b} exhibit differences in correlation between functional
