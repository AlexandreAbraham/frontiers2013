...
\begin{figure}[hbtp]
  \begin{center}
      ...
      \end{subfigure}
  \end{center}
  \caption{Brain parcellations using Kmeans (a) with 50 clusters and 
  Ward clustering (b) with 250 clusters. (c) shows how the original
  signal (d) is compressed using the Ward clustering (b).}
