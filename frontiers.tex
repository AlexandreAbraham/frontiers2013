...
learning techniques on neuroimaging data. PyMVPA does data preprocessing,
...
Here we discuss lower-level patterns that break down how neuroimaging
...
possible application are too wide to be fully exposed in a high-level
interface.
