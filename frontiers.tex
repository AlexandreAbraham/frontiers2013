...
how a general-purpose machine-learning toolbox, scikit-learn, can be used 
for neuroimaging analysis with state-of-the-art methods with code
understandable by both worlds. This paper focuses on code; for a 
more conceptual introduction to machine learning methods in fMRI analysis,
see \cite{pereira2009} or \cite{mur2009}.
We focus on the scikit-learn toolkit as it is a reference
machine learning tool with a very wide variety of algorithms,
...
The scope of this paper is not a neuroimaging-specific library, but rather
code patterns related to scikit-learn. The nilearn library is a software
package under development --\url{http://nilearn.github.io}--
...
unravel simple and didactic examples of code that enables readers to
build there own analysis strategies.
...
Weka \citep{hall2009weka} is a machine learning framework written in Java,
...
learning techniques to neuroimaging. PyMVPA does data preprocessing,
