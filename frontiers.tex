...
% 1995 : SPM impose matlab
% 2000 : FSL

Development of new imaging acquisition methods brought a lot of high dimensional
datasets, which could not be handled by humans (ie doctors). This is why usage
of statistical learning increased in this domain. There are 2 kind of people
studying this field : neurosicentist that learned ML and mathematicians /
Computer scientists that learned NS.

As a reference language in ML,
matlab has imposed itself to NS community, mainly thanks to SPM. 
...
\begin{figure}[hbtp]
  \begin{center}
  \subfigure[f\_score]{\includegraphics[width=.3\linewidth]{img/haxby/haxby_fscore}}
  \subfigure[SVC]{\includegraphics[width=.3\linewidth]{img/haxby/haxby_svm}}
  \subfigure[Searchlight]{\includegraphics[width=.3\linewidth]{img/haxby/haxby_searchlight}}
  \end{center}
...
\begin{figure}[hbtp]
  \begin{center}
  \subfigure[Logistic regression scores]{
    \includegraphics[width=.22\linewidth]{img/kamitani/scores_log}}
  \subfigure[Voxel coefficients for logistic]{
    \includegraphics[width=.22\linewidth]{img/kamitani/pixel_logistic}}
  \subfigure[OMP scores]{
    \includegraphics[width=.22\linewidth]{img/kamitani/scores_omp}}
  \subfigure[Voxel coefficients for OMP]{
    \includegraphics[width=.22\linewidth]{img/kamitani/pixel_omp}}
  \end{center}
  ...
  \begin{center}
    \begin{tikzpicture}
        \begin{scope}[spy using outlines={blue, circle, line width=3pt,
                ...
                \node[rotate=90] {\includegraphics[width=5cm]{img/kamitani/encoding_scores}};
...
\begin{figure}[hbtp]
  \begin{center}
      \subfigure[ICA]{\includegraphics[width=.3\linewidth]{img/ica/ica}}
      \subfigure[CanICA]{\includegraphics[width=.3\linewidth]{img/ica/canica}}
      \subfigure[Melodic]{\includegraphics[width=.3\linewidth]{img/ica/melodic}}
  \end{center}
...
\begin{figure}[hbtp]
  ...
  \subfigure[Ward's clustering]{
    \includegraphics[width=.3\linewidth]{img/clustering/ward}}
  \subfigure[KMeans clustering]{
    \includegraphics[width=.3\linewidth]{img/clustering/kmeans}}
  \end{center}
