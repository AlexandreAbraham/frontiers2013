...
LogisticRegression or Perceptron, is a one liner. You can also chose another
approachs, like k-nearest neighbors, but then a couple of lines are needed to
visualize the results properly.
