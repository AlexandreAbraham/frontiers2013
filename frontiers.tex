...
leads us to explore the internal model of various methods. More theoretical
details on the applied algorithms can be found in \cite{hastie2001}.
...
code patterns related to scikit-learn. The nilearn library --\url{http://nilearn.github.io}-- is a software
