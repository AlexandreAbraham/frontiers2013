...
First, they provide the \verb!ndarray! data type, an efficient $n$-dimensional
data representation. These vectors holds all common operations (transpose...)
and can be easily manipulated thanks to a simple, yet powerful, indexing.

These packages also provides common mathematicals applications applied to
vectors: linear algebra, statistics, algortihms... They are the elementary bricks
