...
\begin{figure}[hbtp]
  \begin{center}
      \subfigure[ICA]{\includegraphics[width=.3\linewidth]{img/ica/ica.png}}
      \subfigure[CanICA]{\includegraphics[width=.3\linewidth]{img/ica/canica.png}}
      \subfigure[Melodic]{\includegraphics[width=.3\linewidth]{img/ica/melodic.png}}
  \end{center}
