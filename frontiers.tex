...
Supervised learning is typically used in \emph{decoding} setting to relate
...
already exists \citep{hanke2009pymvpa}. % Nipy ?
...
\begin{figure}[hbtp]
  ...
  \subfigure[Voxel coefficients for logistic regression]{
      \begin{tikzpicture}
          \begin{scope}[spy using outlines={blue, circle, line width=3pt,
                magnification=7.5, size=60, connect spies}]
            \node[rotate=90]{\includegraphics[width=.22\linewidth]{img/kamitani/pixel_logistic}};
            \spy [width=2.5cm, height=2.5cm, line width=3pt, spy connection path={\draw[line
            width=2pt, blue] (tikzspyonnode) -- (tikzspyinnode);}]
            on (-0.035, -1.33) in node (a) [line width=4pt] (a) at (1, .8) (a) {};
        \end{scope}
    \end{tikzpicture}
    }
    %\includegraphics[width=.22\linewidth, angle=90, origin=c]{img/kamitani/pixel_logistic}}
  ...
  \subfigure[Voxel coefficients for OMP]{
      \begin{tikzpicture}
          \begin{scope}[spy using outlines={blue, circle, line width=3pt,
                magnification=7.5, size=60, connect spies}]
            \node[rotate=90]{\includegraphics[width=.22\linewidth]{img/kamitani/pixel_omp}};
            \spy [width=2.5cm, height=2.5cm, line width=3pt, spy connection path={\draw[line
            width=2pt, blue] (tikzspyonnode) -- (tikzspyinnode);}]
            on (-0.035, -1.33) in node (a) [line width=4pt] (a) at (1, .8) (a) {};
        \end{scope}
    \end{tikzpicture}
    %\includegraphics[width=.22\linewidth, angle=90, origin=c]{img/kamitani/pixel_omp}
    }
  \end{center}
...
\begin{figure}[hbtp]
  ...
  \subfigure[KMeans clustering]{
    \includegraphics[width=.23\linewidth]{img/clustering/kmeans}}
  \subfigure[Ward's clustering]{
    \includegraphics[width=.23\linewidth]{img/clustering/ward}}
  \subfigure[Ward's compression]{
    \includegraphics[width=.23\linewidth]{img/clustering/ward_compressed}}
  \subfigure[Original signal]{
    \includegraphics[width=.23\linewidth]{img/clustering/original}}
  \end{center}
